...
import com.example.codeos2.Adapters.NotesListAdapter;
import com.example.codeos2.Database.RoomDB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(NotesMainActivity.this, NotesTakerActivity.class);
        ...
        switch (item.getItemId()){
            case R.id.pin:
                if (selectedNote.isPinned()){
                    ...
                    Toast.makeText(NotesMainActivity.this, "Unpinned!",Toast.LENGTH_SHORT);
                }
                else {
                    database.mainDAO().pin(selectedNote.getID(), true);
                    Toast.makeText(NotesMainActivity.this, "Pinned!", Toast.LENGTH_SHORT);
                }
