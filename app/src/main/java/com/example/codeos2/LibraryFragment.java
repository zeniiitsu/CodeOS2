...
public class LibraryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        card_myProfile = view.findViewById(R.id.card_myProfile);

        card_notes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent a = new Intent(getContext(), NotesMainActivity.class);
                startActivity(a);
            }
        });
        ...
        card_myProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent b = new Intent(getContext(), MyProfileActivity.class);
                startActivity(b);
            }
        });
